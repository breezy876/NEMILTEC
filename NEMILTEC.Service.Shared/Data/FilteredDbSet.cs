...
{
    public class FilteredDbSet<TEntity> : IDbSet<TEntity>, IOrderedQueryable<TEntity>, IOrderedQueryable,
        IQueryable<TEntity>, IQueryable, IEnumerable<TEntity>, IEnumerable, IListSource
        where TEntity : class, IDataEntity, IDeletable, ITrackable
    {
        ...
        public IQueryable<TEntity> Include(Expression<Func<TEntity, object>> exp)
        {
            return (this.FilteredSet.Include(exp).Where(_filter));
        }
